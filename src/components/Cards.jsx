...
function Card(){
  return(
    ...
    <h2 style={{color:"white",paddingBottom:"60px",paddingTop:"20px"}} >Here are a few <b style={{color:"#F11A7B"}}>works</b> I've done recently.</h2>
    </center></Row>
  ...
  <div class="card-body">
    ...
    <p class="card-text">It is a Musical fun through online. It can be played by using mouse clicks or keyboard buttons respectively.</p>
